...
class GetAvatarUploadUrlQuery:
    candidate_id: UUID
    filename: str
    content_type: str


class GetAvatarUploadUrlHandler:
    def __init__(
        self,
    ...
    async def __call__(self, query: GetAvatarUploadUrlQuery) -> UploadUrlResult:
        ...
        return await self._file_gateway.get_avatar_upload_url(
