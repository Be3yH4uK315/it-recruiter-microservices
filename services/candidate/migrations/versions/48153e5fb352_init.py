...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "contacts_visibility",
            sa.Enum("ON_REQUEST", "PUBLIC", "HIDDEN", name="contactsvisibility"),
            nullable=False,
        ),
        sa.Column("contacts", postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "HIDDEN", "BLOCKED", name="status"),
            nullable=False,
        ),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        op.f("ix_candidates_telegram_id"), "candidates", ["telegram_id"], unique=True
    )
    op.create_table(
        "idempotency_keys",
    ...
    op.create_table(
        ...
        sa.Column(
            "message_body", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_candidate_avatars_candidate_id"),
        "candidate_avatars",
        ["candidate_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "kind",
            sa.Enum("HARD", "SOFT", "TOOL", "LANGUAGE", name="skillkind"),
            nullable=False,
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_candidate_projects_candidate_id"), table_name="candidate_projects"
    )
    ...
    op.drop_index(
        op.f("ix_candidate_education_candidate_id"), table_name="candidate_education"
    )
    op.drop_table("candidate_education")
    op.drop_index(
        op.f("ix_candidate_avatars_candidate_id"), table_name="candidate_avatars"
    )
