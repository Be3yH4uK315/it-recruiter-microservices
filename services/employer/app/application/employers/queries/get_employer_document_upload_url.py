...
class GetEmployerDocumentUploadUrlQuery:
    employer_id: UUID
    filename: str
    content_type: str


class GetEmployerDocumentUploadUrlHandler:
    def __init__(
        self,
    ...
    async def __call__(self, query: GetEmployerDocumentUploadUrlQuery) -> UploadUrlResult:
        ...
        return await self._file_gateway.get_employer_document_upload_url(
