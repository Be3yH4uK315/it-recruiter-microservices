...
class DeleteEmployerDocumentCommand:
    employer_id: UUID


class DeleteEmployerDocumentHandler:
    def __init__(
        self,
    ...
    async def __call__(self, command: DeleteEmployerDocumentCommand) -> None:
        ...
        async with self._uow_factory() as uow:
            ...
            old_file_id = employer.delete_document()
        ...
        await self._file_gateway.cleanup_file(
            file_id=old_file_id,
            reason="employer_document_deleted",
        )
