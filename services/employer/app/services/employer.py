...
class EmployerService:
    ...
    async def get_next_candidate(self, session_id: UUID) -> schemas.NextCandidateResponse:
        ...
        try:
            ...
            full_profile = await self._fetch_full_candidate_profile(
                candidate_id, employer.telegram_id
            )
    ...
    async def request_contact(self, employer_id: UUID, request_in: schemas.ContactsRequestCreate):
        ...
        cand_info = await self._fetch_full_candidate_profile(
            request_in.candidate_id, employer_tg_id
        )
    ...
    async def _fetch_contacts(
        self, candidate_id: UUID, employer_tg_id: int
