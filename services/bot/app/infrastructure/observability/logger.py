...
_SENSITIVE_ASSIGNMENT_RE = re.compile(
    r'(?P<prefix>\b(?:BOT_TOKEN|TELEGRAM_BOT_TOKEN|bot_token|telegram_bot_token)\b\s*[=:]\s*[\'"]?)(?P<value>[^\'"\s,}]+)',
    re.IGNORECASE,
)
_SENSITIVE_JSON_FIELD_RE = re.compile(
    r'(?P<prefix>"(?:BOT_TOKEN|TELEGRAM_BOT_TOKEN|bot_token|telegram_bot_token)"\s*:\s*")(?P<value>[^"]+)',
    re.IGNORECASE,
)
