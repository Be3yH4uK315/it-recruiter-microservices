...
def mock_candidate_api(mocker):
    ...
    mocker.patch("app.handlers.candidate_handlers.candidate_api_client", client)
    mocker.patch("app.handlers.employer_search.candidate_api_client", client)
    return client
...
def mock_employer_api(mocker):
    ...
    mocker.patch("app.handlers.common.employer_api_client", client)
    mocker.patch("app.handlers.employer_search.employer_api_client", client)
    mocker.patch("app.handlers.candidate_handlers.employer_api_client", client)
    return client
...
def mock_file_api(mocker):
    ...
    mocker.patch("app.handlers.candidate_handlers.file_api_client", client)
    mocker.patch("app.handlers.employer_search.file_api_client", client)
    return client
